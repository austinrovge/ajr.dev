    ...
    render() {
        return (
            <footer className="footer">
                <a rel="noopener noreferrer" href="https://github.com/austinrovge/austinrovge.me" target="_blank">
                ...
                <a rel="noopener noreferrer" className="mail-icon" href="mailto:rovgea@msoe.edu" target="_blank">
