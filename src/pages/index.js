    ...
    return (
        <Layout>
            ...
            <div>
                ...
                <p>After graduating from high school, I went to the <ExternalAnchorTag href="https://www.msoe.edu">Milwaukee School of Engineering</ExternalAnchorTag> to major in software engineering. I interned at <ExternalAnchorTag href="https://www.msoe.edu">Direct Supply</ExternalAnchorTag> throughout college and accepted a full time job after </p>
            </div>
        </Layout>
    );
}
